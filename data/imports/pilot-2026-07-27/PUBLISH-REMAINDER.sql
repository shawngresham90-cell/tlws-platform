-- Pilot / Flying J / ONE9 publication REMAINDER — one transaction per
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'CA'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 41 then
    raise exception 'CA: expected 41 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'CA'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 41 then raise exception 'CA: expected to publish 41, published %.', n; end if;
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'CO'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 4 then
    raise exception 'CO: expected 4 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'CO'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 4 then raise exception 'CO: expected to publish 4, published %.', n; end if;
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'IL'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 39 then
    raise exception 'IL: expected 39 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'IL'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 39 then raise exception 'IL: expected to publish 39, published %.', n; end if;
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'IN'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 27 then
    raise exception 'IN: expected 27 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'IN'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 27 then raise exception 'IN: expected to publish 27, published %.', n; end if;
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'MA'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 1 then
    raise exception 'MA: expected 1 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'MA'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 1 then raise exception 'MA: expected to publish 1, published %.', n; end if;
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'NE'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 5 then
    raise exception 'NE: expected 5 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'NE'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 5 then raise exception 'NE: expected to publish 5, published %.', n; end if;
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'NM'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 15 then
    raise exception 'NM: expected 15 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'NM'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 15 then raise exception 'NM: expected to publish 15, published %.', n; end if;
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'OR'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 10 then
    raise exception 'OR: expected 10 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'OR'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 10 then raise exception 'OR: expected to publish 10, published %.', n; end if;
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'TX'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 115 then
    raise exception 'TX: expected 115 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'TX'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 115 then raise exception 'TX: expected to publish 115, published %.', n; end if;
...
begin
  select count(*) into n from public.locations
   where source = 'pilot-master-2026-07-27' and state = 'VA'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  if n <> 18 then
    raise exception 'VA: expected 18 publishable row(s) with parking, found %.', n;
  end if;
  ...
  update public.locations
   ...
   where source = 'pilot-master-2026-07-27' and state = 'VA'
     ...
     and lat is not null and lng is not null and deleted_at is null;
  get diagnostics n = row_count;
  if n <> 18 then raise exception 'VA: expected to publish 18, published %.', n; end if;
