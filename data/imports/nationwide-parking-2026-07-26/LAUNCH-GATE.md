...
| **2b** | Love's Travel Stops — **overnight-parking coverage** | **100 % of 604** | **602 route-usable** by distinct store number (overnight-confirmation closeout 2026-07-28: +9 flips on export-confirmed rows); remaining 2 = #317 Skippers VA (overnight confirmed but row unpublished — quarantined pending a publication authorization) + #420 Flowood (held state-conflict) | ⏳ |
