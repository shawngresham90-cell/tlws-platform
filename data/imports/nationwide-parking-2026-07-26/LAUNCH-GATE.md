...
| **2b** | Love's Travel Stops — **overnight-parking coverage** | **100 % of 604** | **593 route-usable** by distinct store number (closeout 2026-07-28: +15 published matches, +21 resolved inserts, +1 #451 enrichment); remaining 11 = 10 rows awaiting only an `overnight_parking` confirmation write (export says Y for all) + #420 held | ⏳ |
