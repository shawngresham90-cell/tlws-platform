...
east_west = ["Chattanooga","Jasper","Kimball","Monteagle","Hillsboro","Manchester","Christiana",
    "Murfreesboro","Smyrna","La Vergne","Antioch","Joelton","Pleasant View","Clarksville"]
...
# ---- sources.md ----
o = [f"# Batch 11 — I-24 Tennessee: Source Report\n",
     ...
     "confirmation, across corridor segments from the I-75 junction at Chattanooga up over Monteagle",
     "Mountain through Manchester/Murfreesboro and Nashville to Clarksville and the Kentucky line.",
...
r = [f"# Batch 11 — I-24 Tennessee: Review Summary\n",
...
r.append("- Monteagle Mountain runaway-truck ramps and the mandatory brake-check area are held (no civic address / official TDOT facility page); they are safety features, not driver-service or parking facilities.")
...
r.append(f"- Every candidate was compared (normalized name + city, plus `classifyPair` on name/address/phone/website/category/interstate/exit) against all **{tn_live} existing production Tennessee listings** (the I-75 and I-65 batches). This batch is the **I-24** corridor; the existing TN rows are I-75 (Chattanooga↔Knoxville) and I-65 (Nashville↔Alabama line), so there is no exit or address overlap.")
...
r.append("- The TN I-24 corridor is short and largely urban (Chattanooga, Nashville) with long rural mountain stretches, so verified truck-service density is lower than the I-75/I-65 batches; quality over quantity.")
...
# ---- validation.md ----
v = [f"# Batch 11 — I-24 Tennessee: Validation Report\n",
