-- Migration 047: verified mile_marker + three-way overnight_status.
-- EXACT reviewed semantics from data/plans/schema-mm-overnight-2026-07-29/
-- PROPOSED-MIGRATION.sql (merged PR #207), applied under the owner's
-- 2026-07-29 M1 authorization. Additive only; writes no data values;
-- rollback: data/plans/schema-mm-overnight-2026-07-29/PROPOSED-ROLLBACK.sql.
-- NOTE: no CI/Netlify step applies files in this directory (verified);
-- this file is the repository record of the guarded MCP application.
