...
- Condition-specific guides: [Blood Pressure](/knowledge/health-on-the-road/dot-physical-blood-pressure) · [Diabetes](/knowledge/health-on-the-road/diabetes-and-the-dot-physical) · [Sleep Apnea](/knowledge/health-on-the-road/sleep-apnea-and-the-dot-physical)
...
- **Federal regulation:** [391.41(b)(5)](https://www.ecfr.gov/current/title-49/part-391/section-391.41) requires no respiratory dysfunction — and (b)(8)-adjacent concerns about impaired alertness — *likely to interfere with safe operation*. The words "sleep apnea" set no specific test, threshold, or measurement in the regulation. **There is no standalone federal sleep-apnea rule**, and the 2016 FMCSA/FRA rulemaking attempt was [withdrawn in 2017](https://www.federalregister.gov/documents/2017/08/08/2017-16451/evaluation-of-safety-sensitive-personnel-for-moderate-to-severe-obstructive-sleep-apnea).
...
If you read older material describing "applying to FMCSA for a vision exemption," it is describing the pre-2022 world. Long-grandfathered drivers from the old vision-waiver study era remain covered by [391.64](https://www.ecfr.gov/current/title-49/part-391/section-391.64).
...
- **See the whole licensing road:** [How to Get Your CDL](/knowledge/getting-your-cdl/how-to-get-your-cdl) · [TLWS Academy](/academy) · [CDL Pre-School](/cdl-pre-school) · [newsletter](/#newsletter).$mdx$,
      ...
      $j$[
        ...
        {"label":"eCFR — 49 CFR 391.64, Grandfathering (Vision Waiver Study Participants)","url":"https://www.ecfr.gov/current/title-49/part-391/section-391.64"},
...
Historically, drivers hand-delivered the paper certificate (Form MCSA-5876) to the licensing agency. Under the National Registry integration that took effect **June 23, 2025**, examiners report results to FMCSA, and FMCSA transmits certification information **electronically to state agencies** in states that have implemented the connection. Because implementation is uneven, a **federal fallback currently in effect** lets drivers and carriers rely on the **paper certificate for a period after issuance** during the transition. The practical takeaway is not to memorize the plumbing — it is: **ask your examiner for the paper certificate anyway, keep it, and confirm with your state whether they still need anything from you directly.** *(Time-sensitive; this paragraph reflects the transition status as of the review date above.)*
...
- **Losing the paper certificate.** During the transition it remains your proof — carry it as required and keep a copy.
...
- **Career discipline from day one:** [TLWS Academy](/academy) · free [CDL Pre-School](/cdl-pre-school) · [join the email list](/#newsletter).$mdx$,
      ...
      $j$[
        ...
        {"q":"Do I still need to bring my paper medical card to the DMV?","a":"It depends on your state and the transition status. Since June 23, 2025, exam results flow electronically from FMCSA's National Registry to state licensing agencies in implementing states, and a federal fallback currently in effect lets drivers rely on the paper certificate during the transition. The safe practice: get the paper certificate from your examiner, keep it, and confirm directly with your state whether they need anything from you."},
...
- **Paperwork logistics.** Since mid-2025 examiners transmit results into the federal system — but during the [transition](/knowledge/health-on-the-road/medical-card-renewal-and-self-certification), you want the **paper certificate in hand** too; confirm the clinic issues it on the spot.
...
- **Skipping the paper certificate.** During the electronic transition, walking out without the MCSA-5876 in hand is an unforced error.
...
- **Start the career right:** [TLWS Academy](/academy) · free [CDL Pre-School](/cdl-pre-school) · [practice tests](/practice-tests) · [join the email list](/#newsletter).$mdx$,
      ...
      $j$[
        ...
        {"q":"Do I get my medical certificate the same day as the exam?","a":"When the examiner certifies you, the Medical Examiner's Certificate (Form MCSA-5876) is typically issued at the visit, and examiners also report results into the federal system. During the current electronic-reporting transition, leaving with the paper certificate in hand remains the safe practice — confirm before booking that the clinic issues it on the spot."}
      ]$j$::jsonb,
