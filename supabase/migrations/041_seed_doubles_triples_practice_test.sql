...
begin
  ...
  (v_test,
   ...
   '[{"key":"a","text":"They add coupling points and roll or fold more easily than a single trailer"},{"key":"b","text":"They are always loaded heavier, so the brakes fade faster on every downgrade run"},{"key":"c","text":"They are longer overall, so only the passenger-side mirrors stay useful in traffic"},{"key":"d","text":"They are barred from the interstate system and must run slower surface routes"}]'::jsonb,
   'a',
  ...
  (v_test,
   ...
   'd',
   'Rearward amplification means a sudden steering input up front is amplified down the line — a small, quick move at the tractor becomes a large, violent one at the rearmost trailer, which is why a last trailer can flip in a lane change the tractor took easily.',
   'CDL Manual §7.3', '2026-07-17', 2, '{doubles-triples,rearward-amplification,rollover}', 3),
  ...
  (v_test,
   ...
   'CDL Manual §7.3', '2026-07-17', 1, '{doubles-triples,rearward-amplification,rollover}', 4),
  ...
  (v_test,
   ...
   'CDL Manual §7.3', '2026-07-17', 1, '{doubles-triples,steering,lane-position}', 5),
  ...
  (v_test,
   ...
   'CDL Manual §7.3', '2026-07-17', 2, '{doubles-triples,lane-position,space-management}', 6),
  ...
  (v_test,
   ...
   'b',
   'Off-tracking (or cheating) is the rear wheels following a tighter path than the front wheels through a turn. Each trailer adds to it, so a set of doubles or triples swings its rear wheels well inside the tractor path — you must swing wider so the trailers clear curbs and vehicles.',
   'CDL Manual §7.3', '2026-07-17', 2, '{doubles-triples,off-tracking,turns}', 7),
  ...
  (v_test,
   ...
   'CDL Manual §7.3', '2026-07-17', 2, '{doubles-triples,off-tracking,turns}', 8),

  (v_test,
   'What does the manual say about following distance and stopping with doubles or triples on a slippery road?',
   '[{"key":"a","text":"You need extra following distance and gentle braking — the long rig skids easily"},{"key":"b","text":"Following distance can stay normal, because the extra axles add braking traction"},{"key":"c","text":"The rig stops shorter than a single, since the weight spreads over more axles"},{"key":"d","text":"Only the lead trailer matters for stopping distance; the rest simply follow along"}]'::jsonb,
   'a',
   ...
   'CDL Manual §7.3', '2026-07-17', 1, '{doubles-triples,following-distance,stopping}', 9),

  (v_test,
   'What is a converter dolly?',
   '[{"key":"a","text":"A hydraulic jack built into the trailer to raise it during the coupling step"},{"key":"b","text":"The sliding tandem axle assembly mounted underneath the rear trailer of the set"},{"key":"c","text":"A coupling unit with one or two axles and a fifth wheel, used to tow a trailer"},{"key":"d","text":"A spare kingpin carried aboard in case one shears off somewhere on the road"}]'::jsonb,
   'c',
   ...
   'CDL Manual §7.5', '2026-07-17', 1, '{doubles-triples,converter-dolly,coupling}', 10),
  ...
  (v_test,
   ...
   'CDL Manual §7.5', '2026-07-17', 2, '{doubles-triples,pintle-hook,coupling}', 11),

  (v_test,
   'After the pintle hook is latched over the drawbar eye, what must you check?',
   ...
   'CDL Manual §7.5', '2026-07-17', 2, '{doubles-triples,pintle-hook,coupling,inspection}', 12),
  ...
  (v_test,
   ...
   'CDL Manual §7.5', '2026-07-17', 2, '{doubles-triples,coupling,trailer-order,rollover}', 13),
  ...
  (v_test,
   ...
   'CDL Manual §7.5', '2026-07-17', 2, '{doubles-triples,coupling,inspection}', 14),
  ...
  (v_test,
   ...
   'CDL Manual §7.5', '2026-07-17', 3, '{doubles-triples,converter-dolly,coupling}', 15),

  (v_test,
   'After coupling a dolly to a trailer, how do you confirm the connection actually locked?',
   '[{"key":"a","text":"Look that the release lever moved and then assume the locking jaws closed"},{"key":"b","text":"Bounce the trailer by hand and feel for any movement in the seated kingpin"},{"key":"c","text":"Check only that the glad hands sealed and the trailer air pressure held steady"},{"key":"d","text":"Pull gently against the connection with dolly brakes set, then look for closed jaws and no plate gap"}]'::jsonb,
   'd',
   ...
   'CDL Manual §7.5', '2026-07-17', 3, '{doubles-triples,coupling,inspection}', 16),
  ...
  (v_test,
   ...
   'CDL Manual §7.5', '2026-07-17', 2, '{doubles-triples,air-lines,coupling}', 17),

  (v_test,
   'How do glad hands help you avoid crossing the service and emergency air lines between trailers?',
   '[{"key":"a","text":"They are keyed and often color-coded or shaped so the wrong pair will not seal"},{"key":"b","text":"They automatically swap themselves over to the correct port once the system charges"},{"key":"c","text":"They are all built the same size, so any air hose fits any port perfectly safely"},{"key":"d","text":"They will only lock together when the trailer service brakes are already applied"}]'::jsonb,
   'a',
   ...
   'CDL Manual §7.5', '2026-07-17', 2, '{doubles-triples,air-lines,glad-hands}', 18),

  (v_test,
   'What is the purpose of the trailer air-supply shutoff valves (petcocks) at the rear of trailers in a combination?',
   ...
   'CDL Manual §7.6', '2026-07-17', 3, '{doubles-triples,shutoff-valves,air-lines}', 19),
  ...
  (v_test,
   ...
   'CDL Manual §7.6', '2026-07-17', 3, '{doubles-triples,air-lines,inspection}', 20),
  ...
  (v_test,
   ...
   'CDL Manual §7.6', '2026-07-17', 2, '{doubles-triples,hand-valve,brakes}', 21),
  ...
  (v_test,
   ...
   'CDL Manual §7.6', '2026-07-17', 2, '{doubles-triples,hand-valve,parking-brakes}', 22),
  ...
  (v_test,
   ...
   'CDL Manual §7.6', '2026-07-17', 2, '{doubles-triples,tractor-protection-valve,brakes}', 23),
  ...
  (v_test,
   ...
   'CDL Manual §7.6', '2026-07-17', 2, '{doubles-triples,spring-brakes,emergency-brakes}', 24),
  ...
  (v_test,
   ...
   'CDL Manual §7.5', '2026-07-17', 2, '{doubles-triples,coupling,trailer-alignment}', 28),
  ...
  (v_test,
   ...
   'CDL Manual §7.3', '2026-07-17', 1, '{doubles-triples,emergency-handling,rollover}', 29),
  ...
  (v_test,
   ...
   'CDL Manual §7.3', '2026-07-17', 1, '{doubles-triples,space-management,driving}', 32);
