...
writeFileSync(`${outDir}/../data/imports/i65-tennessee-batch-009-expansion-report.csv`, expansionReportCsv(report));
...
const newPairs = csvToPairs(masterPath, 'tn');
...
writeFileSync(`${outDir}/dup-summary.json`, JSON.stringify({ gaHits, tnHits, kyHits, ohHits, miHits, flHits, inHits, alHits, liveHits, inFile, inBatchSlugDupes: inBatchSlugDupes.length }, null, 1));
console.log('DONE');
