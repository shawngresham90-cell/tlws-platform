...
| 3 | Scene 02 · The Pre-Trip | `truck-walkaround` | B-roll | Truck walkaround | _unlabeled pending — needs viewing_ |
| 4 | Scene 02 · The Pre-Trip | `backing` | B-roll | Backing | _unlabeled pending — needs viewing_ |
| 5 | Scene 02 · The Pre-Trip | `climb-into-cab` | B-roll | Climb into cab | _unlabeled pending — needs viewing_ |
| 6 | Scene 02 · The Pre-Trip | `air-brake-check` | B-roll | Air brake check | _unlabeled pending — needs viewing_ |
| 7 | Scene 03 · The Grind | `truck-stop` | B-roll | Truck stop | _unlabeled pending — needs viewing_ |
| 8 | Scene 03 · The Grind | `empty-highway` | B-roll | Empty highway | _unlabeled pending — needs viewing_ |
| 9 | Scene 03 · The Grind | `rain-driving` | B-roll | Rain driving | _unlabeled pending — needs viewing_ |
| 10 | Scene 04 · First Light | `hero-shot` | B-roll | Hero shot | _unlabeled pending — needs viewing_ |
| 11 | Scene 04 · First Light | `drone-shot` | B-roll | Drone shot | _unlabeled pending — needs viewing_ |
| 12 | Scene 04 · First Light | `academy-footage` | B-roll | Academy footage | _unlabeled pending — needs viewing_ |
| 13 | Scene 07 · Legacy | `student-training` | B-roll | Student training | _unlabeled pending — needs viewing_ |
| 14 | Scene 07 · Legacy | `key-handoff` | B-roll | Key handoff | _unlabeled pending — needs viewing_ |
| 15 | Scene 07 · Legacy | `student-success` | B-roll | Student success | _unlabeled pending — needs viewing_ |
