  ...
  return (
    <div>
      ...
      <p className="max-w-xl text-muted">
        ...
        <span className="font-semibold text-signal">{admin.role}</span>. Dashboard screens are
        built in a later milestone — this page only confirms the route is protected.
      </p>
    </div>
  );
}
