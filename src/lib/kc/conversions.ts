 ...
 * Every href must be a live route (covered by the internal link crawl).
 */
...
const PRESCHOOL: KcConversion = {
  ...
  blurb: 'Prepare before CDL school — 7 modules built the driver way.',
  href: '/cdl-pre-school',
...
const BY_CATEGORY: Record<string, KcConversion[]> = {
  'dot-compliance': [PRACTICE_TESTS, BOOKS],
