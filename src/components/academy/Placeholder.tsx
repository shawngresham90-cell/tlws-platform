...
export function Placeholder({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-flex items-center gap-1 rounded-card border border-dashed border-diesel bg-diesel/10 px-2 py-0.5 align-baseline text-sm font-semibold text-diesel">
