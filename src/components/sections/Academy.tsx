  ...
  return (
    <Section id="academy" className="border-b border-line">
      ...
      <p className="mt-8 max-w-2xl text-muted">
        <strong className="text-ink">Tuition {TUITION}</strong> · {ACADEMY_ADDRESS.oneLine} ·
        Weekend classes begin October 2026, Saturdays and Sundays for eight weekends. A weekday
        program of approximately three to four weeks begins January 2027.
      </p>
      <div className="mt-9">
