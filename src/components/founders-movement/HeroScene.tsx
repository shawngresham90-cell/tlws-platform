 ...
 */
export function HeroScene({ founderCount }: { founderCount: number }) {
  ...
  return (
    <div className="relative isolate flex min-h-[92svh] flex-col justify-end overflow-hidden bg-asphalt">
